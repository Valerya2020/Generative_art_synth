...
export default class Container extends Component {
  ...
  handleStart = () => {
    ...
    drumsJcReverb = new Tone.JCReverb(drumsSettings.jcReverb)
    drumsChorus = new Tone.Chorus(drumsSettings.chorus).start()
    drumsPingPongDelay = new Tone.PingPongDelay(drumsSettings.pingPongDelay)
